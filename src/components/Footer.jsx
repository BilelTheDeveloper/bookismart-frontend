    ...
    <footer className="bg-slate-900 text-white pt-24 pb-12 overflow-hidden relative">
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8 mb-20">
          ...
          {/* Quick Links */}
          <div className="space-y-6">
            <h4 className="text-sm font-black uppercase tracking-[0.3em] text-indigo-400">{t("footer.platform")}</h4>
            <ul className="space-y-4">
              {[
                t("footer.links.browse"),
                t("footer.links.professionals"),
                t("footer.links.waiting"),
                t("footer.links.help"),
              ].map((item) => (
                <li key={item}>
          ...
          {/* Trust & Security */}
          <div className="space-y-6">
            <h4 className="text-sm font-black uppercase tracking-[0.3em] text-indigo-400">{t("footer.security")}</h4>
            <ul className="space-y-4">
              {[
                t("footer.securityLinks.shield"),
                t("footer.securityLinks.privacy"),
                t("footer.securityLinks.terms"),
                t("footer.securityLinks.partners"),
              ].map((item) => (
                <li key={item}>
                  <a href="#" className="text-slate-400 font-bold hover:text-white transition-colors">{item}</a>
                </li>
            ...
            <div className="pt-4 flex items-center gap-3">
              <div className="bg-white/5 border border-white/10 px-4 py-2 rounded-2xl flex items-center gap-2">
                <span className="text-[10px] font-black uppercase text-slate-400">{t("footer.poweredBy")}</span>
          ...
          {/* Newsletter */}
          <div className="space-y-6">
            <h4 className="text-sm font-black uppercase tracking-[0.3em] text-indigo-400">{t("footer.newsletter")}</h4>
        ...
        <div className="pt-12 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-6">
          ...
          <div className="flex gap-8">
            <span className="text-[10px] font-black text-slate-600 tracking-tighter uppercase cursor-default hover:text-indigo-400 transition-colors">{t("footer.securityVer")}</span>
            <span className="text-[10px] font-black text-slate-600 tracking-tighter uppercase cursor-default hover:text-indigo-400 transition-colors">{t("footer.saasVer")}</span>
          </div>
        </div>
      </div>
    </footer>
