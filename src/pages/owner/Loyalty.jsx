  ...
  return (
    <div className="fixed inset-0 bg-slate-900/60 backdrop-blur-sm z-50 flex items-center justify-center p-4" onClick={onClose}>
      <div className="bg-white dark:bg-slate-900 rounded-3xl shadow-2xl w-full max-w-md p-8 relative" onClick={e => e.stopPropagation()}>
        ...
        <h2 className="text-2xl font-black text-slate-900 dark:text-white mb-6">New Discount Code</h2>
                ...
                {["fixed", "percent"].map(t => (
                  <button key={t} type="button" onClick={() => setForm(f => ({ ...f, type: t }))}
                    className={`flex-1 py-2 rounded-lg font-black text-xs capitalize transition-all ${
                      form.type === t ? "bg-indigo-600 text-white shadow" : "text-slate-500 hover:text-slate-800 dark:text-slate-100"
  ...
  return (
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-black text-slate-900 dark:text-white tracking-tighter">Loyalty & Rewards</h1>
        ...
        {[
          ...
          <button key={t.key} onClick={() => setActiveTab(t.key)}
            className={`flex items-center gap-2 px-5 py-2.5 rounded-xl font-black text-sm transition-all ${
              activeTab === t.key ? "bg-white text-indigo-600 shadow-md" : "text-slate-500 hover:text-slate-800 dark:text-slate-100"
            }`}>
            {t.icon} {t.label}
          </button>
        ))}
      ...
      {activeTab === "program" && program && (
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="bg-white dark:bg-slate-900 rounded-3xl border border-slate-100 dark:border-slate-800 shadow-sm p-8 space-y-5">
            <h3 className="text-xl font-black text-slate-900 dark:text-white">Program Details</h3>
            <div>
      ...
      {activeTab === "codes" && (
        <div className="bg-white dark:bg-slate-900 rounded-3xl border border-slate-100 dark:border-slate-800 shadow-sm overflow-hidden">
          <div className="p-6 border-b border-slate-50 flex items-center justify-between">
            <div>
              <h3 className="text-xl font-black text-slate-900 dark:text-white">Discount Codes</h3>
                  ...
                  <div key={code._id} className={`flex items-center justify-between p-5 rounded-2xl border-2 transition-all ${
                    ...
                    <div className="flex items-center gap-4">
                      <div className="text-right text-xs">
                        <p className="font-black text-slate-600 dark:text-slate-300">{code.usedCount} / {code.maxUses || "∞"} uses</p>
                        {code.expiresAt && (
      ...
      {activeTab === "customers" && (
        <div className="bg-white dark:bg-slate-900 rounded-3xl border border-slate-100 dark:border-slate-800 shadow-sm overflow-hidden">
          <div className="p-6 border-b border-slate-50">
            <h3 className="text-xl font-black text-slate-900 dark:text-white">Customer Loyalty Points</h3>
